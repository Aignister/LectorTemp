    ...
    public partial class Form1 : Form
    {
        ...
        private void btnAbrir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                serialPort1.BaudRate = Convert.ToInt32(cmbCom2.Text);
                serialPort1.Open();
        ...
        private void btnCerrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Desconectando de la tarjeta arduino");
            }
            catch(Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void Show_Data(object sender, EventArgs e)
        {
            if(actDato == true)
            {
                ...
                lblHum.Text = string.Format("Humedad= {0}%HR", humedad.ToString());

                chart1.Series["Temperatura"].Points.Add(temperatura);
                chart1.Series["Humedad"].Points.Add(humedad);
            }
        }
